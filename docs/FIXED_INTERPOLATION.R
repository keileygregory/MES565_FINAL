...
bkg <- read_csv("docs/data/original_data_OUTLIERS/outliers_erddap_UVI2_Around_STX_20250306.csv")

# Import humpback detection data with GIS calculations
hbk <- read_csv("docs/data/original_data_OUTLIERS/outliers_GISCALC_HUWH_AroundSTX2025.csv")
